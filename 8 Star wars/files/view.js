...
function createCatalogItem(episodeId, episodeTitle, episodeDescription, edisodeImg) {
	...
	catalogImg.style.background = `url('/img/episode/epi_${edisodeImg}.jpeg') center/cover no-repeat`;
...
function createCatalog({ episodeId, episodeTitle, episodeDescription }) {
	...
	const catalogItem = createCatalogItem(episodeId, episodeTitle, episodeDescription, edisodeImg);
